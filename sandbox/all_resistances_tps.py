...
class AttributeSet(object):
    ...
    def __init__(self, label, pawn_name, pt, pawnbalance, classdef):
        ...
        self.cryo = AttributePair('Cryo', pt, pawnbalance, classdef, asv_dict,
                base_dot_chance='BaseFreezeChanceResistanceModifier',
                base_dot_duration='BaseFreezeDurationResistanceModifier',
                base_damage='BaseIceDamageModifiers',
                mod_is_useless=True,
                mod_dot_chance='D_Attributes.StatusEffectModifiers.CryoChanceResistanceModifier',
                mod_dot_duration=None,
                mod_impact='D_Attributes.DamageTypeModifers.IceImpactDamageModifier',
                mod_dot_damage='D_Attributes.DamageTypeModifers.IceStatusEffectDamageModifier',
                )
    ...
    def get_labels(self):
        ...
        labels.extend(self.cryo.get_labels())
        return labels
    ...
    def get_data(self):
        ...
        data.extend(self.cryo.get_data())
        return data
